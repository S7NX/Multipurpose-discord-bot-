...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix, player) => {
    ...
    try {
      ...
      embed.addField("**<:arrow_right:1007600686164361268> Rules Channel:**", `${message.guild.rulesChannel ? `<#${message.guild.rulesChannelId}>`: "<:no:1007436622733774911> \`No Channel\`"}`, true)
      embed.addField("**<:arrow_right:1007600686164361268> Public Updates Channel:**", `${message.guild.publicUpdatesChannel ? `<#${message.guild.publicUpdatesChannelId}>`: "<:no:1007436622733774911> \`No Channel\`"}`, true)
      embed.addField("**<:arrow_right:1007600686164361268> AFK Channel:**", `${message.guild.afkChannel ? `<#${message.guild.afkChannelId}>`: "<:no:1007436622733774911> \`No Channel\`"}`, true)

      embed.addField("**<:arrow_right:1007600686164361268> NSFW Level:**", `\`${message.guild.nsfwLevel}\``, true)
      embed.addField("**<:arrow_right:1007600686164361268> Verifcation Level:**", `\`${message.guild.verificationLevel}\``, true)
      embed.addField("**<:arrow_right:1007600686164361268> Explicit Content Filter:**", `\`${message.guild.explicitContentFilter}\``, true)
      ...
      embed.addField(client.la[ls].cmds.info.serverinfo.field12, "<a:nitro:1007611787350376540> \`" + message.guild.premiumSubscriptionCount + "\`", true)

      embed.addField(client.la[ls].cmds.info.serverinfo.field13, `<a:nitro:1007611787350376540> \`${boostlevel}\``, true)
      embed.addField(client.la[ls].cmds.info.serverinfo.field14, "👾 \`" + maxbitrate + " kbps\`", true)
      if(boosts >= 14){
          embed.addField(`**<:arrow_right:1007600686164361268> Vanity:**`, `${message.guild.vanityURLCode ? `https://discord.gg/${message.guild.vanityURLCode}` : "<:no:1007436622733774911> No Vanity-Invite"}`)
      }
      ...
      if(message.guild.banner) {
        ...
        .setTitle(`**<:arrow_right:1007600686164361268> SERVER BANNER:**`)
        ...
        let embed2 = new Discord.MessageEmbed()
        .setTitle(`**<:arrow_right:1007600686164361268> SERVER DISCOVERY SPLASH:**`)
