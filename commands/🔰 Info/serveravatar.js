...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      .addField("<:arrow_right:1007600686164361268> PNG",`[\`LINK\`](${message.guild.iconURL({format: "png"})})`, true)
      .addField("<:arrow_right:1007600686164361268> JPEG",`[\`LINK\`](${message.guild.iconURL({format: "jpg"})})`, true)
      .addField("<:arrow_right:1007600686164361268> WEBP",`[\`LINK\`](${message.guild.iconURL({format: "webp"})})`, true)
