...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      .addField("**CURRENT INVITES:**", `<:Like:1007623270872383508> ${user} _**has invited __${realinvites} Member${realinvites != 1 ? "s": ""}__**_!`)
      ...
      async function menuselection(menu) {
        ...
        await menu?.reply({embeds : [new MessageEmbed()
          ...
          message.reply({embeds : [new MessageEmbed()
            ...
            .addField("\u200b", `<:Like:1007623270872383508> ${user} _**has invited __${realinvites} Member${realinvites != 1 ? "s": ""}__**_!`)
