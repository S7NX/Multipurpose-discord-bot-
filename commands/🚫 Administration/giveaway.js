        ...
        if (args[0].toLowerCase() === "start") {
            try{
                ...
                let options = {
                    ...
                    prize: `<a:Gift:1007623897946017812> ${giveawayPrize} <a:Gift:1007623897946017812>`,
                    ...
                    bonusEntries: [],
                    messages: {
                        inviteToParticipate: "***React with <a:Tada:1007453154725593190> to participate!***\n",
                        drawing: "> Ends: {timestamp}\n",
                        hostedBy: "**Hosted by:** {this.hostedBy}",
                        dropMessage: "Be the first to react with <a:Tada:1007453154725593190>",
                        noWinner: "\n**Giveaway cancelled!**\n> No valid participations. :cry:",
                        endedAt: "Ends at", 
                        giveaway: '<a:Tada:1007453154725593190> **GIVEAWAY STARTED** <a:Tada:1007453154725593190>',
                        giveawayEnded: '<a:cyan_tad:1007608573754351616> **GIVEAWAY ENDED** <a:cyan_tad:1007608573754351616>',
            ...
            client.giveawaysManager.reroll(giveaway.messageId, { winnerCount: !isNaN(args[1]) ? Number(args[1]) : 1})
                ...
                .catch((e) => {
                    if (e.startsWith(`Giveaway with message Id ${giveaway.messageId} is not ended.`)) {
                        ...
                        console.error(e);
                        message.reply({content : '<:no:1007436622733774911> **An error occured...**```' + String(e.message).substring(0, 1900) + "```"});
                    }
                });
