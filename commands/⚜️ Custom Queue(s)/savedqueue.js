  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      case `addcurrenttrack`: {
        ...
        //return susccess message
        return message.reply({embeds : [new MessageEmbed()
          .setTitle(`<a:yes_animated:1007611220842528799> Added ${track.title} onto the Queue \`${Name}\``.substring(0, 256))
      ...
      case `removesong`: {
        ...
        //return susccess message
        return message.reply({embeds :[new MessageEmbed()
          .setTitle(`<a:yes_animated:1007611220842528799> Deleted ${deletetrack.title} of the Queue \`${Name}\``.substring(0, 256))
      ...
      case `mix`: {
        ...
        //return susccess message
        return message.reply({embeds : [new MessageEmbed()
          .setTitle(`<a:yes_animated:1007611220842528799> Shuffled ${newtracks.length} Tracks of the Queue \`${Name}\``.substring(0, 256))
      ...
      case `removeduplicates`: {
        ...
        //return susccess message
        return message.reply({embeds : [new MessageEmbed()
          .setTitle(`<a:yes_animated:1007611220842528799> Removed ${counter} Tracks from the Queue \`${Name}\``.substring(0, 256))
