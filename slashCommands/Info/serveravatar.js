...
module.exports = {
  ...
  run: async (client, interaction, cmduser, es, ls, prefix, player, message) => {
    ...
    try {
      ...
      .addField("<:arrow_right:1007600686164361268> PNG",`[\`LINK\`](${guild.iconURL({format: "png"})})`, true)
      .addField("<:arrow_right:1007600686164361268> JPEG",`[\`LINK\`](${guild.iconURL({format: "jpg"})})`, true)
      .addField("<:arrow_right:1007600686164361268> WEBP",`[\`LINK\`](${guild.iconURL({format: "webp"})})`, true)
