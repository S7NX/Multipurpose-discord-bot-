  ...
  run: async (client, interaction, cmduser, es, ls, prefix, player, message) => {
    ...
    if (customavatar) {
      let embed = new MessageEmbed()
        ...
        .addField("<:arrow_right:1007600686164361268> PNG", `[\`LINK\`](${customavatar})`, true)
        .addField("<:arrow_right:1007600686164361268> JPEG", `[\`LINK\`](${customavatar.replace("png", "jpg").replace("gif", "jpg")})`, true)
        .addField("<:arrow_right:1007600686164361268> WEBP", `[\`LINK\`](${customavatar.replace("png", "webp").replace("gif", "webp")})`, true)
        .setURL(customavatar)
      ...
      let embed = new MessageEmbed()
        ...
        .setColor(es.color).setThumbnail(es.thumb ? es.footericon && (es.footericon.includes("http://") || es.footericon.includes("https://")) ? es.footericon : client.user.displayAvatarURL() : null)
        .addField("<:arrow_right:1007600686164361268> PNG", `[\`LINK\`](${user.displayAvatarURL({format: "png"})})`, true)
        .addField("<:arrow_right:1007600686164361268> JPEG", `[\`LINK\`](${user.displayAvatarURL({format: "jpg"})})`, true)
        .addField("<:arrow_right:1007600686164361268> WEBP", `[\`LINK\`](${user.displayAvatarURL({format: "webp"})})`, true)
