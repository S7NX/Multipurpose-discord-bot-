  ...
  run: async (client, interaction, cmduser, es, ls, prefix, player, message) => {
    ...
    let color = options.getString("color");
      ...
      const embed = new Discord.MessageEmbed()
        ...
        .addField('<:arrow_right:1007600686164361268> **Name**', json.name, true)
        .addField("<:arrow_right:1007600686164361268> **Hex**", json.hex, true)
        .addField("<:arrow_right:1007600686164361268> **RGB**", json.rgb, true)
        .addField(`<:arrow_right:1007600686164361268> **${client.la[ls].cmds.info.color.brightershade}**`, json.brightened, true)
